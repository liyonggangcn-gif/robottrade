#!/usr/bin/env python3
"""从 MySQL 导入近1年数据到 DuckDB，用于快速回测"""
import duckdb
import time
import os
...
DUCKDB_PATH = '/home/li/robottrade/data/quant_backtest.duckdb'
...
def main():
    ...
    for table in target_tables:
        ...
        print(f'  完成: {cnt:,} 条, 耗时 {elapsed:.1f}s')
